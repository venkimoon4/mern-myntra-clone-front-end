...
import { createUserCartItems, getUserCartItems } from "../controllers/userController.js";
...
useEffect(()=>{
  ...
  const handleAddProductToBag=async(item)=>{
    if(email!==null){
    try{
      ...
      <div className="product">
        ...
        <div className="rating-container">
          ...
          <div className="heart-container wishCheckbox" title="Like">
            <input type="checkbox" className="checkbox" defaultChecked={isChecked} id="Give-It-An-Id" onClick={/*()=>*/handleAddItemsToWishList/*(item.id)*/}/>
       ...
       <button style={{backgroundColor:"green"}} onClick={()=>handleAddProductToBag(item)}><GrAddCircle className="icon"/>Add to Bag</button> 
